...
import net.playground.ipinfoservice.exception.ApplicationException;
import net.playground.ipinfoservice.exception.NotFoundException;
import net.playground.ipinfoservice.exception.ValidationException;
